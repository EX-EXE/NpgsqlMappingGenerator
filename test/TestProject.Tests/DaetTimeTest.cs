...
public class DateTimeTest : PrepareDataBase, IAsyncLifetime
{
    ...
    {
        var dateTime = new DateTime(0, 1, 2, 3, 4, 5, DateTimeKind.Local);
        var dateTimeUtc = new DateTime(6, 7, 8, 9, 10, 11, DateTimeKind.Utc);
        var dateTimeOffset = new DateTimeOffset(12, 13, 14, 15, 16, 17, TimeSpan.FromHours(9.0));
