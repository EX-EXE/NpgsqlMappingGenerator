...
[DbTableGenerator("public.missing_dbcolumn")]
public partial class MissingDbColumn
{
    ...
    {
        using var cmd = new NpgsqlCommand($"create table {DbTableQuery} (id uuid not null ,first_name text not null ,last_name text not null ,primary key (id) );", connection);
