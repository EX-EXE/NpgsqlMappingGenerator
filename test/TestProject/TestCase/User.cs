...
public partial class UserData
{
    ...
    {
        using var cmd = new NpgsqlCommand("create table public.userdata (id uuid not null ,first_name text not null ,last_name text not null ,last_update timestamp(6) with time zone not null  ,primary key (id),UNIQUE (first_name,last_name) );", connection);
